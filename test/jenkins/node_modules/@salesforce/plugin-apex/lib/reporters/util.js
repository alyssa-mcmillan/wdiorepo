...
function buildOutputDirConfig(result, jsonOutput, outputDir, resultFormat, detailedCoverage, synchronous = false) {
    ...
    switch (resultFormat) {
        case 'tap':
            ...
            (_a = outputDirConfig.fileInfos) === null || _a === void 0 ? void 0 : _a.push({
                filename: `test-result.txt`,
                content: tapResult
            });
            (_b = outputDirConfig.resultFormats) === null || _b === void 0 ? void 0 : _b.push(apex_node_1.ResultFormat.tap);
            break;
        case 'junit':
            const junitResult = new apex_node_1.JUnitReporter().format(result);
            (_c = outputDirConfig.fileInfos) === null || _c === void 0 ? void 0 : _c.push({
