import { TestResult, OutputDirConfig, ResultFormat } from '@salesforce/apex-node';
 ...
 */
export declare function buildOutputDirConfig(result: TestResult, jsonOutput: CliJsonFormat, outputDir: string, resultFormat: ResultFormat | undefined, detailedCoverage: boolean, synchronous?: boolean): OutputDirConfig;
