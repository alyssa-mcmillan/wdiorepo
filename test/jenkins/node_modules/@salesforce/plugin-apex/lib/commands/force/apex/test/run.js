    ...
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            process.on('uncaughtException', err => {
                const formattedErr = this.formatError(new core_1.SfdxError(messages.getMessage('apexLibErr', [err.message])));
            ...
            if (this.flags.synchronous && testLevel === "RunSpecifiedTests" /* RunSpecifiedTests */) {
                ...
                result = yield testService.runTestAsynchronous(payload, this.flags.codecoverage, reporter, this.cancellationTokenSource.token);
            }
            ...
            if (this.flags.outputdir) {
                ...
                const outputDirConfig = reporters_1.buildOutputDirConfig(result, jsonOutput, this.flags.outputdir, this.flags.resultformat, this.flags.detailedcoverage, this.flags.synchronous);
                ...
                switch (this.flags.resultformat) {
                    ...
                    default:
                        if (this.flags.synchronous) {
                            ...
                            this.ux.log(messages.getMessage('runTestReportCommand', [id, username]));
                        }
                }
            }
            catch (e) {
...
Run.description = utils_1.buildDescription(messages.getMessage('commandDescription'), messages.getMessage('longDescription'));
