...
const hook = async function (options) {
    ...
    try {
        ...
        const telemetry = (global.cliTelemetry = await telemetry_2.default.create({ cacheDir: this.config.cacheDir }));
        ...
        debuger_1.debug('Setting up process exit handler');
        ...
        const error = err;
        debuger_1.debug('Error with logging or sending telemetry:', error.message);
    }
};
