...
class Grant extends command_1.SfdxCommand {
    async run() {
        ...
        try {
            ...
            const msg = ts_types_1.getString(err, 'message');
            throw core_1.SfdxError.create('@salesforce/plugin-auth', 'jwt.grant', 'JwtGrantError', [msg]);
        }
    ...
    async initAuthInfo() {
        ...
        const loginUrl = await common_1.Common.resolveLoginUrl(ts_types_1.get(this.flags.instanceurl, 'href', null));
