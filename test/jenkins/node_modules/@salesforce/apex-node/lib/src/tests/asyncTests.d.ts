...
import { ApexTestProgressValue, ApexTestQueueItem, ApexTestResult, ApexTestRunResultRecord, AsyncTestArrayConfiguration, AsyncTestConfiguration, TestResult } from './types';
export declare class AsyncTests {
     ...
     */
    runTests(options: AsyncTestConfiguration | AsyncTestArrayConfiguration, codeCoverage?: boolean, progress?: Progress<ApexTestProgressValue>, token?: CancellationToken): Promise<TestResult>;
    /**
