...
class CodeCoverage {
    ...
    queryPerClassCodeCov(apexTestClassSet) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const perClassCodeCovResuls = (yield this.connection.tooling.autoFetchQuery(util.format(perClassCodeCovQuery, `${str}`)));
    ...
    queryAggregateCodeCov(apexClassIdSet) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const codeCoverageResuls = (yield this.connection.tooling.autoFetchQuery(util.format(codeCoverageQuery, `${str}`)));
