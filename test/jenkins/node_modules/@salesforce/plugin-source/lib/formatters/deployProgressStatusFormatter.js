...
class DeployProgressStatusFormatter extends progressFormatter_1.ProgressFormatter {
    ...
    printDeployStatus(data) {
        ...
        const componentsTotal = ts_types_1.getNumber(data, 'numberComponentsTotal');
        if (componentsTotal) {
            const componentsDeployed = ts_types_1.getNumber(data, 'numberComponentsDeployed');
            const componentErrors = ts_types_1.getNumber(data, 'numberComponentErrors');
            const testsTotal = ts_types_1.getNumber(data, 'numberTestsTotal');
            const testsCompleted = ts_types_1.getNumber(data, 'numberTestsCompleted');
            const testErrors = ts_types_1.getNumber(data, 'numberTestErrors');
