...
class DeployReportResultFormatter extends deployResultFormatter_1.DeployResultFormatter {
    display() {
        const status = ts_types_1.getString(this, 'result.response.status', 'unknown');
        ...
        if (status === types_1.RequestStatus.Failed) {
            throw core_1.SfdxError.create('@salesforce/plugin-source', 'report', 'mdapiDeployFailed');
        }
        return;
    }
}
