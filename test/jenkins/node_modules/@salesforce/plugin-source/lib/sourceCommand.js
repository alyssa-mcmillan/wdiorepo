...
class SourceCommand extends command_1.SfdxCommand {
    ...
    isJsonOutput() {
        return ts_types_1.getBoolean(this.flags, 'json', false);
    }
    getFlag(flagName, defaultVal) {
        return ts_types_1.get(this.flags, flagName, defaultVal);
    }
    initProgressBar() {
    ...
    async getSourceApiVersion() {
        ...
        return ts_types_1.getString(projectConfig, 'sourceApiVersion');
    }
}
