    ...
    static async build(options) {
        ...
        try {
            if (sourcepath) {
                ...
                sourcepath.forEach((filepath) => {
                    if (core_1.fs.fileExistsSync(filepath)) {
                        csAggregator.push(...source_deploy_retrieve_1.ComponentSet.fromSource(path.resolve(filepath)));
                    }
                    else {
            ...
            if (packagenames) {
                ...
                csAggregator.push(...new source_deploy_retrieve_1.ComponentSet([]));
            }
            ...
            if (manifest) {
                ...
                const compSet = await source_deploy_retrieve_1.ComponentSet.fromManifest({
            ...
            if (metadata) {
                ...
                const fromSource = source_deploy_retrieve_1.ComponentSet.fromSource({ fsPaths: directoryPaths, include: filter });
        ...
        const componentSet = new source_deploy_retrieve_1.ComponentSet(csAggregator);
