...
class Retrieve extends sourceCommand_1.SourceCommand {
    ...
    resolveSuccess() {
        const status = ts_types_1.getString(this.retrieveResult, 'response.status');
    ...
    async formatResult() {
        ...
        this.getFlag('packagenames', []).forEach((name) => {
            packages.push({ name, path: path_1.join(projectPath, name) });
        });
...
Retrieve.flagsConfig = {
    ...
    wait: command_1.flags.minutes({
        char: 'w',
        default: kit_1.Duration.minutes(sourceCommand_1.SourceCommand.DEFAULT_SRC_WAIT_MINUTES),
