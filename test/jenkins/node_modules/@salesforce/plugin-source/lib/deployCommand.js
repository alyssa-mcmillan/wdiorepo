...
class DeployCommand extends sourceCommand_1.SourceCommand {
    constructor() {
        super(...arguments);
        this.displayDeployId = kit_1.once((id) => {
    ...
    resolveDeployId(id) {
        if (id) {
            ...
            try {
                ...
                stash.readSync(true);
                const deployId = ts_types_1.asString(stash.get(DeployCommand.STASH_KEY).jobid);
    ...
    async isRestDeploy() {
        if (ts_types_1.getBoolean(this.flags, 'soapdeploy') === true) {
    ...
    async poll(deployId, options) {
        ...
        const defaultOptions = {
            ...
            poll: async () => {
                ...
                return {
                    completed: ts_types_1.getBoolean(deployResult, 'response.done'),
