...
class OrgDisplayCommand extends command_1.SfdxCommand {
    ...
    async getScratchOrgInformation(orgId) {
        ...
        throw new core_1.SfdxError(messages.getMessage('noScratchOrgInfoError', [core_1.sfdc.trimTo15(orgId), hubOrg.getUsername()]), 'NoScratchInfo', [messages.getMessage('noScratchOrgInfoAction')]);
    }
}
