const Page = require('C:\\Users\\AlyssaMcMillan\\work\\traction-rec-integrations\\gtest\\node_modules\\.bin\\features\\pageobjects\\page.js')
    ...
    class CommunityEvent extends Page {
        ...
        get newtitle() {return $('//h2[contains(text(), "New Community Event")]')}
        ...
        get recordinglink() {return $('//input[@name="gather__ah_Recording_Link__c"]')}
        ...
        open() {
            ...
            super.open('*.lightning.force.com/lightning/o/gather__ah_Community_Event__c');
...
module.exports = new CommunityEvent();
